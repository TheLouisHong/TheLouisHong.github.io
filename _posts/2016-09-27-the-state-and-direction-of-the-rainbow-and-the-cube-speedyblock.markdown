...
---
The new map color design are much more diverse and interesting for the player to explore. Like before, these maps skin will change based on what level the player is in, making new high scores more memorable. In order to achieve this, I rewrote our map skin code and created a nice editor for the designers to experiment with colors in-game real-time. For the first time I've made use of the custom editor feature and it has immediately paid off. Dali and Sam had an awesome time designing maps with the new editor, and put great amount of time and effor in the designs. And now, we are now able to proudly present 5 new maps!
